...
<div class="container">
    ...
    <c:if test="${not empty ocorrencia}">
        ...
        <div class="comentarios-section">
                ...
                <c:when test="${not empty comentarios}">
                    <c:forEach var="c" items="${comentarios}">
                        <div class="comentario">
                            ...
                            <c:if test="${not empty c.nomeArquivoAnexo}">
                                <div class="anexo">
                                    <a href="/ftp/download?arquivo=${c.nomeArquivoAnexo}" target="_blank">Baixar anexo: ${c.nomeArquivoAnexo}</a>
                                </div>
                            </c:if>
                        </div>
                    </c:forEach>
            ...
            <form class="novo-comentario-form" method="post" action="/forum/${ocorrencia.id}/comentar" enctype="multipart/form-data">
